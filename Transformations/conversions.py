...
###################################################
# LEFT-HAND TO RIGHT-HAND COORDINATES SYSTEM      #
###################################################

def conv_L_to_R_coordinate_system(translation: np.array, rotation: np.ndarray):
    """
    Basically, you have to invert all rotations (R'' = R'^T) and flip one axis, usually y-axis (y'' = -y')
    :param translation:
    :param rotation:
    :return:
    """
    ...
    # flip one axis (in my case its the y-axis)
    t = translation
    t[1] = -t[1]
